// rest-svc.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    try
    {
        //http_listener listener( L"http://127.0.0.1:9000/restdemo" );

        web::http::experimental::listener::http_listener listener(U("http://localhost:8080/cpprest"));
